...
- Usa `src/assets/brand/logosolmet.png` como marca gráfica; no la reemplaces por texto ni la redibujes.
- Conserva los temas claro y oscuro, el selector persistente y las fotografías sin filtros en ambos.
- Respeta el sistema tipográfico del logo: Oxanium en titulares, Inter Tight en etiquetas y CTAs, Inter en cuerpo.
...
3. Prueba 320, 768, 1024 y 1440 px, en tema claro y oscuro, sin desbordamiento horizontal.
